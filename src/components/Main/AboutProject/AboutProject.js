...
function AboutProject() {
  return (
    <section id="about" className="about page__section">
      ...
      <ul className="about__desc-list">
        <li className="about__desc-lis-item">
          ...
          <p className="paragraph about__desc-paragraph">Составление плана, работу над бэкендом, вёрстку, добавление функциональности и финальные доработки.</p>
        </li>
        <li className="about__desc-lis-item">
          <h3 className="about__desc-title">На выполнение диплома ушло 5 недель</h3>
          <p className="paragraph about__desc-paragraph">У каждого этапа был мягкий и жёсткий дедлайн, которые нужно было соблюдать, чтобы успешно защититься.</p>
        </li>
      </ul>
