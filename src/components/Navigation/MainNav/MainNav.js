      ...
      <nav className="main-nav__menu">
        <ul className="main-nav__list">
          <li className="main-nav__list-item main-nav__list-item_link-direction_main-page">
            <NavLink exact to="/" className="link main-nav__link" activeClassName="main-nav__link_active">Главная</NavLink>
          </li>
          <li className="main-nav__list-item">
            <NavLink to="/movies" className="link main-nav__link" activeClassName="main-nav__link_active">Фильмы</NavLink>
          </li>
          <li className="main-nav__list-item">
            <NavLink to="/saved-movies" className="link main-nav__link" activeClassName="main-nav__link_active">Сохранённые фильмы</NavLink>
          </li>
        </ul>

        <Link to="/profile" className="main-nav__profile">Аккаунт
